...
// Faz a requisição para a API do SUAP
        ...
        //     // Obtém os dados do usuário (nome e e-mail)
        //     $data = $response->json();

        //     // Verifique as chaves reais da resposta (ajuste conforme necessário)
        //     $nome = isset($data['nome_usual']) ? $data['nome_usual'] : 'Nome não disponível';
        //     $email = isset($data['email']) ? $data['email'] : 'E-mail não disponível';
        ...
        //     return redirect()->route('login')->with('error', 'Falha na requisição com o SUAP.');
        // }
    }
}
