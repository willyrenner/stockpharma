...
const CadastrarRemedios = () => {
  return (
    ...
    >
      <Head title="Cadastrar Remédios" />
      <div className="min-h-screen bg-gray-100 dark:bg-gray-900 py-8 px-4">

        {/* Categories */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Tarja Amarela */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow transform hover:scale-105 transition-transform">
            <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-200">Tarja Amarela</h2>
            <img
          ...
          {/* Tarja Vermelha */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow transform hover:scale-105 transition-transform">
            <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-200">Tarja Vermelha</h2>
            <img
          ...
          {/* Tarja Preta */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow transform hover:scale-105 transition-transform">
            <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-200">Tarja Preta</h2>
            <img
